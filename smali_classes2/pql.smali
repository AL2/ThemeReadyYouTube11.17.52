...
# instance fields
.field private g:Lprz;


# direct methods
.method private constructor <init>(Lkvc;Ljava/security/Key;Lkvc;Lrfm;Llfp;)V
    .locals 3

    .prologue
    .line 66
    invoke-direct {p0, p2, p3, p4}, Lrfn;-><init>(Ljava/security/Key;Lkvc;Lrfm;)V

    .line 67
    new-instance v0, Lprz;

    invoke-direct {v0, p2, p5, p1}, Lprz;-><init>(Ljava/security/Key;Llfp;Lkvc;)V

    iput-object v0, p0, Lpql;->g:Lprz;

    .line 1152
    iget-object v0, p0, Lrfn;->c:Lorg/apache/http/protocol/HttpRequestHandlerRegistry;

    .line 68
    const-string v1, "/pudl"

    iget-object v2, p0, Lpql;->g:Lprz;
...
.method public static a(Lkvc;Ljava/security/Key;Lkvc;Lrfm;Llfp;)Lpql;
    .locals 7
    ...
    invoke-direct/range {v0 .. v5}, Lpql;-><init>(Lkvc;Ljava/security/Key;Lkvc;Lrfm;Llfp;)V
    ...
    iput-object v1, v0, Lrfn;->e:Ljava/net/ServerSocket;
    ...
    .line 1146
    iget-object v2, v0, Lrfn;->e:Ljava/net/ServerSocket;
    ...
    iput-object v1, v0, Lrfn;->f:Ljava/util/concurrent/ExecutorService;

    .line 1148
    iget-object v1, v0, Lrfn;->f:Ljava/util/concurrent/ExecutorService;

    new-instance v2, Lrfo;

    invoke-direct {v2, v0}, Lrfo;-><init>(Lrfn;)V
...
.method public final a(Ljava/lang/String;ILjava/lang/String;JJJ)Landroid/net/Uri;
    ...
    .line 1160
    iget-object v1, p0, Lrfn;->e:Ljava/net/ServerSocket;
    ...
    .line 2156
    iget-object v1, p0, Lrfn;->d:Lrgg;

    .line 90
    invoke-virtual {v1, v0}, Lrgg;->a(Landroid/net/Uri;)Landroid/net/Uri;

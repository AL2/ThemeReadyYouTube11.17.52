...
.field private d:Lies;


# direct methods
.method constructor <init>(Lorg/apache/http/client/HttpClient;Landroid/content/Context;Lies;)V
    .locals 9
    ...
    iput-object v1, p0, Lier;->c:Landroid/content/Context;
    ...
    .line 0
    iput-object v0, p0, Lier;->a:Ljava/lang/String;

    iput-object p1, p0, Lier;->b:Lorg/apache/http/client/HttpClient;

    iput-object p3, p0, Lier;->d:Lies;
...
.method private static a(Licb;)Ljava/net/URL;
    .locals 2

    .prologue
    .line 3000
    iget-object v1, p0, Licb;->c:Ljava/lang/String;
...
.method private final a(Ljava/net/URL;)Lorg/apache/http/HttpEntityEnclosingRequest;
    .locals 5
    ...
    iget-object v2, p0, Lier;->a:Ljava/lang/String;
...
.method public final a(Ljava/util/List;)V
    ...
    invoke-static {v0}, Lier;->a(Licb;)Ljava/net/URL;
    ...
    iget-object v2, p0, Lier;->d:Lies;

    invoke-interface {v2, v0}, Lies;->b(Licb;)V
    ...
    :cond_0
    invoke-direct {p0, v2}, Lier;->a(Ljava/net/URL;)Lorg/apache/http/HttpEntityEnclosingRequest;
    ...
    invoke-static {v6}, Lier;->a(Lorg/apache/http/HttpEntityEnclosingRequest;)V

    if-eqz v1, :cond_2

    :try_start_0
    iget-object v2, p0, Lier;->c:Landroid/content/Context;

    invoke-static {v2}, Lict;->a(Landroid/content/Context;)V

    move v1, v3

    :cond_2
    iget-object v2, p0, Lier;->b:Lorg/apache/http/client/HttpClient;
    ...
    invoke-interface {v2, v0}, Lies;->c(Licb;)V
    ...
    invoke-interface {v2, v0}, Lies;->a(Licb;)V
    :try_end_0
    ...
    invoke-static {v6}, Lias;->b(Ljava/lang/String;)V
...
.method public final a()Z
    ...
    iget-object v0, p0, Lier;->c:Landroid/content/Context;

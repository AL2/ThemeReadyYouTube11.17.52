...
.field private volatile c:Ligf;

.field private final d:Licg;
...
.method constructor <init>(Licg;Landroid/content/Context;)V
    .locals 1

    const-string v0, "gtm_urls.db"

    invoke-direct {p0, p1, p2, v0}, Lidi;-><init>(Licg;Landroid/content/Context;Ljava/lang/String;)V

    return-void
.end method

.method private constructor <init>(Licg;Landroid/content/Context;Ljava/lang/String;)V
    .locals 4
    ...
    iput-object v0, p0, Lidi;->e:Landroid/content/Context;

    iput-object p3, p0, Lidi;->f:Ljava/lang/String;

    iput-object p1, p0, Lidi;->d:Licg;

    invoke-static {}, Lgug;->c()Lguc;

    move-result-object v0

    iput-object v0, p0, Lidi;->h:Lguc;

    new-instance v0, Lidk;

    iget-object v1, p0, Lidi;->e:Landroid/content/Context;

    iget-object v2, p0, Lidi;->f:Ljava/lang/String;

    invoke-direct {v0, p0, v1, v2}, Lidk;-><init>(Lidi;Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lidi;->b:Lidk;
    ...
    iget-object v2, p0, Lidi;->e:Landroid/content/Context;

    new-instance v3, Lidj;

    invoke-direct {v3, p0}, Lidj;-><init>(Lidi;)V

    invoke-direct {v0, v1, v2, v3}, Lier;-><init>(Lorg/apache/http/client/HttpClient;Landroid/content/Context;Lies;)V

    iput-object v0, p0, Lidi;->c:Ligf;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lidi;->g:J
...
.method private final a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_0
    iget-object v0, p0, Lidi;->b:Lidk;

    invoke-virtual {v0}, Lidk;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
...
.method static synthetic a(Lidi;)Lguc;
    .locals 1

    iget-object v0, p0, Lidi;->h:Lguc;
...
.method private final a(I)Ljava/util/List;
    ...
    invoke-direct {p0, v0}, Lidi;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method private final a(J)V
    ...
    invoke-direct {p0, v0}, Lidi;->a([Ljava/lang/String;)V

    return-void
.end method

.method static synthetic a(Lidi;J)V
    .locals 1

    invoke-direct {p0, p1, p2}, Lidi;->a(J)V

    return-void
.end method

.method static synthetic a(Lidi;JJ)V
    .locals 7
...
.method private final a([Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2}, Lidi;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v2, p0, Lidi;->d:Licg;

    invoke-direct {p0}, Lidi;->c()I
    ...
    :goto_1
    invoke-interface {v2, v0}, Licg;->a(Z)V
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method static synthetic b(Lidi;)Ljava/lang/String;
    .locals 1

    iget-object v0, p0, Lidi;->f:Ljava/lang/String;
...
.method private final b()Ljava/util/List;
    ...
    invoke-direct {v0, v2}, Lidi;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct {v3, v4, v5, v6, v7}, Licb;-><init>(JJ)V
    ...
    invoke-static {v3}, Lias;->b(Ljava/lang/String;)V
    :try_end_5
    ...
    :cond_9
    :try_start_6
    iput-object v5, v2, Licb;->c:Ljava/lang/String;
    :try_end_6
    ...
    invoke-static {v2}, Lias;->b(Ljava/lang/String;)V
    ...
    .line 6000
    iget-object v6, v2, Licb;->c:Ljava/lang/String;
...
.method static synthetic c(Lidi;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lidi;->e:Landroid/content/Context;
...
.method public final a()V
    ...
    iget-object v0, p0, Lidi;->c:Ligf;

    invoke-interface {v0}, Ligf;->a()Z
    ...
    :cond_1
    invoke-direct {p0}, Lidi;->b()Ljava/util/List;
    ...
    iget-object v0, p0, Lidi;->d:Licg;

    const/4 v1, 0x1

    invoke-interface {v0, v1}, Licg;->a(Z)V

    goto :goto_0

    :cond_2
    iget-object v1, p0, Lidi;->c:Ligf;

    invoke-interface {v1, v0}, Ligf;->a(Ljava/util/List;)V

    invoke-direct {p0}, Lidi;->d()I
...
.method public final a(JLjava/lang/String;)V
    ...
    .line 1000
    iget-object v2, p0, Lidi;->h:Lguc;

    invoke-interface {v2}, Lguc;->a()J

    move-result-wide v2

    iget-wide v4, p0, Lidi;->g:J
    ...
    invoke-direct {p0, v0}, Lidi;->a(I)Ljava/util/List;

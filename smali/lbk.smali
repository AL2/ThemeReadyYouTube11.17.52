...
# direct methods
.method constructor <init>(Lkxo;Lkua;)V
    .locals 1
    ...
    iput-object v0, p0, Llbk;->b:Lkua;

    .line 62
    return-void
.end method

.method private static a(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lauq;)V
    .locals 2

    .prologue
    .line 180
    invoke-virtual {p1}, Lauq;->q()[B
...
# virtual methods
.method public final a(Lauq;Ljava/util/Map;)Lorg/apache/http/HttpResponse;
    .locals 6
    ...
    .line 74
    invoke-virtual {p1}, Lauq;->b()Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lauq;->l()Ljava/lang/String;
    ...
    .line 83
    :goto_1
    invoke-static {v2, p2}, Llbk;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V

    .line 84
    invoke-virtual {p1}, Lauq;->i()Ljava/util/Map;

    move-result-object v3

    invoke-static {v2, v3}, Llbk;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V
    ...
    .line 2109
    sget-object v5, Llbl;->a:[I

    invoke-virtual {v3}, Laus;->ordinal()I
    ...
    .line 93
    iget-object v3, p0, Llbk;->b:Lkua;

    invoke-virtual {v3, v1}, Lkua;->d(Ljava/lang/Object;)V

    .line 3104
    :cond_0
    iget-object v1, p0, Llbk;->a:Lkxo;
    ...
    .line 97
    iget-object v2, p0, Llbk;->b:Lkua;

    invoke-virtual {v2, v0}, Lkua;->d(Ljava/lang/Object;)V
    ...
    invoke-virtual {p1}, Lauq;->p()Ljava/lang/String;
    ...
    .line 1151
    invoke-static {v2, p1}, Llbk;->a(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lauq;)V
    ...
    invoke-direct {v2, v3}, Lavm;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3, v4}, Lavm;->addHeader(Ljava/lang/String;Ljava/lang/String;)V

...
.method public constructor <init>(Landroid/content/Context;Ltjm;)V
    .locals 1
    ...
    iput-object v0, p0, Lced;->b:Landroid/content/Context;
    ...
    iput-object v0, p0, Lced;->d:Ltjm;

    .line 46
    invoke-static {p1}, Lwem;->a(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lced;->c:Ljava/lang/String;
...
.method public final a(Landroid/app/Activity;Landroid/net/Uri;)Z
    ...
    .line 58
    iget-object v0, p0, Lced;->c:Ljava/lang/String;
    ...
    iget-object v5, p0, Lced;->b:Landroid/content/Context;

    .line 1243
    sget-object v6, Llgj;->a:Llgz;
    ...
    .line 2070
    invoke-virtual {v6, v5}, Llgz;->a(Landroid/content/Context;)Ljava/util/Set;
    ...
    .line 66
    iget-object v0, p0, Lced;->d:Ltjm;

    iget-boolean v0, v0, Ltjm;->b:Z
    ...
    invoke-static {p1, v0, v1}, Llhv;->a(Landroid/content/Context;II)I
    ...
    .line 71
    iget-object v1, p0, Lced;->b:Landroid/content/Context;
    ...
    invoke-direct {v6, v1}, Leo;-><init>(Landroid/app/ActivityOptions;)V

    .line 4048
    invoke-direct {v0, v6}, Len;-><init>(Leo;)V

    .line 3393
    :goto_3
    invoke-virtual {v0}, Lem;->a()Landroid/os/Bundle;
    ...
    iget-object v3, p0, Lced;->c:Ljava/lang/String;
    ...
    iget-object v4, p0, Lced;->b:Landroid/content/Context;

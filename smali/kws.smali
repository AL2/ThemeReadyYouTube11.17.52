...
# direct methods
.method public constructor <init>(Lkxo;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Lkwl;-><init>(Lkxo;)V

    iput-object v0, p0, Lkws;->a:Lkwl;
    ...
    iput-object v0, p0, Lkws;->b:Landroid/net/Uri;
    ...
    .line 48
    iput-object p4, p0, Lkws;->d:Ljava/lang/String;

    .line 49
    return-void
.end method

.method private static a(Lorg/apache/http/HttpResponse;)Lvqk;
    .locals 3
...
.method private static b(Lorg/apache/http/HttpResponse;)Lvqj;
    .locals 3
...
# virtual methods
.method public final a(Llgf;)Landroid/net/Uri;
    .locals 8
    ...
    .line 1135
    iget-object v1, p0, Lkws;->b:Landroid/net/Uri;
    ...
    invoke-virtual {v2, v1}, Lkxy;->a(Landroid/net/Uri;)Lorg/apache/http/client/methods/HttpUriRequest;
    ...
    .line 1142
    iget-object v1, p0, Lkws;->d:Ljava/lang/String;

    invoke-static {v2, v1}, Lkws;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/lang/String;)V

    .line 61
    :goto_0
    invoke-virtual {p1}, Llgf;->b()J
    ...
    .line 63
    :try_start_0
    iget-object v1, p0, Lkws;->a:Lkwl;

    invoke-virtual {v1, v2}, Lkwl;->a(Lorg/apache/http/client/methods/HttpUriRequest;)Lorg/apache/http/HttpResponse;

    move-result-object v1

    .line 64
    invoke-static {v1}, Lkws;->a(Lorg/apache/http/HttpResponse;)Lvqk;

    move-result-object v1

    .line 65
    iget-object v1, v1, Lvqk;->a:[Ljava/lang/String;
    ...
    .line 2078
    :cond_1
    iget-object v1, p1, Llgf;->a:Llgh;

    .line 2135
    iget-wide v2, v1, Llgh;->c:J
...
.method public final a(Lkwm;Llgf;)Lkwy;
    .locals 8
    ...
    .line 2147
    iget-object v0, p0, Lkws;->b:Landroid/net/Uri;
    ...
    .line 3021
    iget-object v2, p1, Lkwm;->a:Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Lkxy;->a(Landroid/net/Uri;)Lorg/apache/http/client/methods/HttpUriRequest;
    ...
    invoke-static {v2, v0}, Lkws;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/lang/String;)V

    .line 106
    :goto_1
    invoke-virtual {p2}, Llgf;->b()J
    ...
    .line 108
    :try_start_0
    iget-object v0, p0, Lkws;->a:Lkwl;

    invoke-virtual {v0, v2}, Lkwl;->a(Lorg/apache/http/client/methods/HttpUriRequest;)Lorg/apache/http/HttpResponse;
    :try_end_0
    .catch Lorg/apache/http/client/HttpResponseException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 129
    :cond_4
    invoke-static {v0}, Lkws;->b(Lorg/apache/http/HttpResponse;)Lvqj;
    ...
    iget-object v2, v1, Lvqj;->a:[Lvqh;

    iget-wide v4, v1, Lvqj;->b:J

    invoke-direct {v0, p1, v2, v4, v5}, Lkwy;-><init>(Lkwm;[Lvqh;J)V

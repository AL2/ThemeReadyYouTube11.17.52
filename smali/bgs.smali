...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbgs;->d:Ljava/util/Set;
    ...
    sput-object v0, Lbgs;->e:Ljava/util/Set;

    .line 82
    invoke-static {v4}, Lbln;->a(I)Ljava/util/Queue;

    move-result-object v0

    sput-object v0, Lbgs;->f:Ljava/util/Queue;

    return-void
.end method

.method public constructor <init>(Landroid/util/DisplayMetrics;Lbbb;Lbaw;)V
    .locals 1
    ...
    iput-object v0, p0, Lbgs;->h:Landroid/util/DisplayMetrics;
...
.method private final a(Ljava/io/InputStream;)I
    ...
    iget-object v2, p0, Lbgs;->i:Lbaw;

    invoke-direct {v1, p1, v2}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;-><init>(Ljava/io/InputStream;Lbaw;)V
...
.method private final a(Ljava/io/InputStream;Laxk;)Landroid/graphics/Bitmap$Config;
    .locals 4
...
.method private static a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Lbgu;)Landroid/graphics/Bitmap;
    .locals 9
    ...
    .line 9488
    invoke-static {p1}, Lbgs;->b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
...
.method private static b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lbgs;->a(Landroid/graphics/Bitmap;)Ljava/lang/String;
...
.method private final b(Ljava/io/InputStream;)Z
    ...
    iget-object v1, p0, Lbgs;->i:Lbaw;

    invoke-direct {v0, p1, v1}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;-><init>(Ljava/io/InputStream;Lbaw;)V
    ...
    .line 356
    sget-object v1, Lbgs;->e:Ljava/util/Set;
...
.method private static declared-synchronized c()Landroid/graphics/BitmapFactory$Options;
    ...
    :try_start_0
    sget-object v2, Lbgs;->f:Ljava/util/Queue;
    ...
    .line 504
    :try_start_1
    sget-object v0, Lbgs;->f:Ljava/util/Queue;
    ...
    .line 508
    invoke-static {v0}, Lbgs;->d(Landroid/graphics/BitmapFactory$Options;)V
    :try_end_2
...
.method private static c(Landroid/graphics/BitmapFactory$Options;)V
    ...
    .prologue
    .line 515
    invoke-static {p0}, Lbgs;->d(Landroid/graphics/BitmapFactory$Options;)V

    .line 516
    sget-object v1, Lbgs;->f:Ljava/util/Queue;
...
# virtual methods
.method public final a(Ljava/io/InputStream;IILaxs;Lbgu;)Lbap;
    .locals 18
    ...
    iget-object v2, v0, Lbgs;->i:Lbaw;

    const/high16 v3, 0x10000

    const-class v4, [B

    invoke-interface {v2, v3, v4}, Lbaw;->a(ILjava/lang/Class;)Ljava/lang/Object;
    ...
    .line 151
    invoke-static {}, Lbgs;->c()Landroid/graphics/BitmapFactory$Options;
    ...
    .line 154
    sget-object v3, Lbgs;->a:Laxp;

    move-object/from16 v0, p4

    invoke-virtual {v0, v3}, Laxs;->a(Laxp;)Ljava/lang/Object;
    ...
    .line 155
    sget-object v4, Lbgs;->b:Laxp;

    move-object/from16 v0, p4

    invoke-virtual {v0, v4}, Laxs;->a(Laxp;)Ljava/lang/Object;
    ...
    invoke-static {v0, v10, v1}, Lbgs;->a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Lbgu;)Landroid/graphics/Bitmap;
    ...
    .line 4177
    invoke-direct/range {p0 .. p1}, Lbgs;->a(Ljava/io/InputStream;)I
    ...
    invoke-direct {v0, v1, v3}, Lbgs;->a(Ljava/io/InputStream;Laxk;)Landroid/graphics/Bitmap$Config;
    ...
    .line 5316
    :cond_3
    invoke-direct/range {p0 .. p1}, Lbgs;->b(Ljava/io/InputStream;)Z
    ...
    .line 5318
    invoke-static {v10}, Lbgs;->a(Landroid/graphics/BitmapFactory$Options;)Z
    ...
    .line 5496
    invoke-interface {v4, v6, v8, v3}, Lbbb;->b(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    iget-object v3, v0, Lbgs;->g:Lbbb;

    move-object/from16 v0, p5

    invoke-interface {v0, v3, v4}, Lbgu;->a(Lbbb;Landroid/graphics/Bitmap;)V
    ...
    .line 6447
    invoke-static {v4}, Lbgs;->a(Landroid/graphics/Bitmap;)Ljava/lang/String;
    ...
    .line 6449
    invoke-static {v10}, Lbgs;->b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
    ...
    iget-object v3, v0, Lbgs;->h:Landroid/util/DisplayMetrics;
    ...
    invoke-static {v3, v4, v12}, Lbhf;->a(Lbbb;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    iget-object v5, v0, Lbgs;->g:Lbbb;

    invoke-interface {v5, v4}, Lbbb;->a(Landroid/graphics/Bitmap;)V
    ...
    invoke-static {v3, v4}, Lbge;->a(Landroid/graphics/Bitmap;Lbbb;)Lbge;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 162
    invoke-static {v10}, Lbgs;->c(Landroid/graphics/BitmapFactory$Options;)V

    .line 163
    move-object/from16 v0, p0

    iget-object v4, v0, Lbgs;->i:Lbaw;

    const-class v5, [B

    invoke-interface {v4, v2, v5}, Lbaw;->a(Ljava/lang/Object;Ljava/lang/Class;)V
    ...
    :cond_9
    :try_start_1
    invoke-virtual {v4, v9, v7, v6, v8}, Lbgk;->a(IIII)F
    ...
    :cond_c
    :try_start_2
    invoke-virtual {v4, v7, v9, v6, v8}, Lbgk;->a(IIII)F
    ...
    sget-object v13, Lbgs;->d:Ljava/util/Set;

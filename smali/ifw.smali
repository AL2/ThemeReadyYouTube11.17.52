...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0, v1, v2}, Lifw;-><init>(Landroid/content/Context;Lguc;Ljava/lang/String;Ljava/util/concurrent/Executor;)V

    return-void
.end method

.method private constructor <init>(Landroid/content/Context;Lguc;Ljava/lang/String;Ljava/util/concurrent/Executor;)V
    .locals 2
    ...
    iput-object p2, p0, Lifw;->e:Lguc;

    const/16 v0, 0x7d0

    iput v0, p0, Lifw;->f:I

    iput-object p4, p0, Lifw;->b:Ljava/util/concurrent/Executor;

    new-instance v0, Liga;

    iget-object v1, p0, Lifw;->c:Landroid/content/Context;

    invoke-direct {v0, p0, v1, p3}, Liga;-><init>(Lifw;Landroid/content/Context;Ljava/lang/String;)V
...
.method private final a()Ljava/util/List;
    ...
    .line 0
    :try_start_0
    iget-object v0, p0, Lifw;->e:Lguc;

    invoke-interface {v0}, Lguc;->a()J

    move-result-wide v0

    invoke-direct {p0, v0, v1}, Lifw;->a(J)V

    invoke-direct {p0}, Lifw;->b()Ljava/util/List;
    ...
    iget-object v4, v0, Ligb;->a:Ljava/lang/String;

    iget-object v0, v0, Ligb;->b:[B

    invoke-static {v0}, Lifw;->a([B)Ljava/lang/Object;

    move-result-object v0

    invoke-direct {v3, v4, v0}, Liah;-><init>(Ljava/lang/String;Ljava/lang/Object;)V
...
.method private final a(I)Ljava/util/List;
    ...
    invoke-direct {p0, v0}, Lifw;->b(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method static synthetic a(Lifw;)Ljava/util/List;
    .locals 1

    invoke-direct {p0}, Lifw;->a()Ljava/util/List;
...
.method static synthetic a(Lifw;Ljava/lang/String;)V
    .locals 7
...
.method static synthetic a(Lifw;Ljava/util/List;J)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lifw;->b(Ljava/util/List;J)V
...
.method static synthetic b(Lifw;)Landroid/content/Context;
    .locals 1
...
.method private final b(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-virtual {v0}, Liga;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private final b()Ljava/util/List;
    ...
    invoke-direct {v0, v2, v3}, Ligb;-><init>(Ljava/lang/String;[B)V
...
.method private final declared-synchronized b(Ljava/util/List;J)V
    ...
    invoke-direct {p0, v2, v3}, Lifw;->a(J)V
    ...
    invoke-direct {p0, v0}, Lifw;->a(I)Ljava/util/List;
    ...
    invoke-direct {p0, p1, v0, v1}, Lifw;->c(Ljava/util/List;J)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {p0, v1}, Lifw;->b(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method private final c()I
    ...
    invoke-direct {p0, v2}, Lifw;->b(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method private final c(Ljava/util/List;J)V
    ...
    iget-object v5, v0, Ligb;->a:Ljava/lang/String;
...
.method private final d()V
    ...
    invoke-virtual {v0}, Liga;->close()V
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final a(Liak;)V
    ...
    iget-object v0, p0, Lifw;->b:Ljava/util/concurrent/Executor;

    new-instance v1, Lify;

    invoke-direct {v1, p0, p1}, Lify;-><init>(Lifw;Liak;)V
...
.method public final a(Ljava/lang/String;)V
    ...
    invoke-direct {v1, p0, p1}, Lifz;-><init>(Lifw;Ljava/lang/String;)V
...
.method public final a(Ljava/util/List;J)V
    ...
    iget-object v4, v0, Liah;->a:Ljava/lang/String;

    iget-object v0, v0, Liah;->b:Ljava/lang/Object;

    invoke-static {v0}, Lifw;->a(Ljava/lang/Object;)[B

    move-result-object v0

    invoke-direct {v3, v4, v0}, Ligb;-><init>(Ljava/lang/String;[B)V
    ...
    invoke-direct {v2, p0, v1, p2, p3}, Lifx;-><init>(Lifw;Ljava/util/List;J)V

...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ljqt;->a:Ljava/nio/charset/Charset;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Ljpa;Lpdu;)V
    .locals 1
    ...
    iput-object v0, p0, Ljqt;->b:Landroid/content/Context;
...
.method private static a(Lvrz;)Ljava/lang/String;
    ...
    .line 6034
    :try_start_1
    iget-object v1, v1, Lvrd;->c:Ljava/io/InputStream;
    ...
    :cond_4
    :try_start_2
    invoke-static {v1}, Lkus;->a(Ljava/io/InputStream;)[B
    :try_end_2
    ...
    invoke-static {v2, v0, v1}, Ljqt;->a(ILvrc;[B)Laun;
    ...
    sget-object v5, Ljqt;->a:Ljava/nio/charset/Charset;
...
.method private final a(Ljqf;Ljava/lang/String;Ljava/lang/String;)Lvrz;
    .locals 8
    ...
    iget-object v1, p0, Ljqt;->b:Landroid/content/Context;
    ...
    .line 1073
    iget-object v2, p1, Ljqf;->a:Landroid/net/Uri;
    ...
    .line 2069
    iget-wide v6, p1, Ljqf;->c:J

    .line 162
    const/high16 v1, 0x100000

    invoke-direct {v4, v0, v6, v7, v1}, Lvrk;-><init>(Ljava/io/InputStream;JI)V
    :try_end_1
    ...
    .line 3065
    iget-object v1, p1, Ljqf;->b:Ljava/security/MessageDigest;

    .line 4055
    iput-object v1, v0, Lvsf;->b:Ljava/security/MessageDigest;
    ...
    invoke-direct {v1, v0}, Ljql;-><init>(Ljava/lang/Throwable;)V
...
.method public final a(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Ljqt;->b:Landroid/content/Context;

    invoke-virtual {v0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v0

    invoke-static {v0, p1}, Ljqf;->a(Landroid/content/ContentResolver;Landroid/net/Uri;)Ljqf;
    :try_end_0
    ...
    .line 103
    invoke-direct {p0, v0, p2, p3}, Ljqt;->a(Ljqf;Ljava/lang/String;Ljava/lang/String;)Lvrz;

    move-result-object v0

    .line 106
    :try_start_1
    invoke-static {v0}, Ljqt;->a(Lvrz;)Ljava/lang/String;
    :try_end_1
    .catch Laum; {:try_start_1 .. :try_end_1} :catch_1
    .catch Lauz; {:try_start_1 .. :try_end_1} :catch_2
    .catch Laup; {:try_start_1 .. :try_end_1} :catch_3

...
.method public final a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, p1, p2}, Lgkl;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    :try_end_0
    .catch Lgkm; {:try_start_0 .. :try_end_0} :catch_0
    .catch Lgkn; {:try_start_0 .. :try_end_0} :catch_1
    .catch Lgkk; {:try_start_0 .. :try_end_0} :catch_2
    ...
    .line 48
    invoke-virtual {v0}, Lgkm;->getMessage()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0}, Lgkm;->a()Landroid/content/Intent;

    move-result-object v3

    invoke-direct {v1, v2, v3, v0}, Liog;-><init>(Ljava/lang/String;Landroid/content/Intent;Ljava/lang/Exception;)V
    ...
    invoke-virtual {v0}, Lgkn;->getMessage()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0}, Lgkn;->a()Landroid/content/Intent;

    move-result-object v0

    invoke-direct {v1, v2, v0}, Lioh;-><init>(Ljava/lang/String;Landroid/content/Intent;)V
...
.method public final a(ILjava/lang/String;)Ljava/util/List;
    ...
    .line 98
    invoke-static {v0, p1, p2}, Lgkl;->a(Landroid/content/Context;ILjava/lang/String;)Ljava/util/List;
    ...
    invoke-direct {v3, v0}, Lioi;-><init>(Lcom/google/android/gms/auth/AccountChangeEvent;)V
...
.method public final a(Ljava/lang/String;)V
    ...
    invoke-static {v0, p1}, Lgkl;->a(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_0
    .catch Lgkk; {:try_start_0 .. :try_end_0} :catch_0

...
.method public constructor <init>(Ljava/io/InputStream;Lbaw;)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Lbaw;

    .line 100
    new-instance v0, Lbgz;

    invoke-direct {v0, p1}, Lbgz;-><init>(Ljava/io/InputStream;)V

    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lbgy;

    .line 101
    return-void
.end method

.method public constructor <init>(Ljava/nio/ByteBuffer;Lbaw;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Lbgw;-><init>(Ljava/nio/ByteBuffer;)V
...
.method private static a(Lbgx;)I
    .locals 10
    ...
    invoke-virtual {p0, v0}, Lbgx;->b(I)S
    ...
    invoke-virtual {p0, v0}, Lbgx;->a(I)I
    ...
    .line 304
    invoke-virtual {p0, v1}, Lbgx;->b(I)S
    ...
    .line 309
    invoke-virtual {p0, v3}, Lbgx;->b(I)S
    ...
    invoke-virtual {p0, v5}, Lbgx;->b(I)S
    ...
    invoke-virtual {p0, v6}, Lbgx;->a(I)I
    ...
    .line 6396
    iget-object v5, p0, Lbgx;->a:Ljava/nio/ByteBuffer;
    ...
    .line 7396
    iget-object v6, p0, Lbgx;->a:Ljava/nio/ByteBuffer;
...
.method private final c()I
    ...
    .line 246
    :cond_0
    iget-object v1, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lbgy;

    invoke-interface {v1}, Lbgy;->b()S
    ...
    .line 269
    iget-object v3, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lbgy;

    int-to-long v4, v1

    invoke-interface {v3, v4, v5}, Lbgy;->a(J)J
...
.method public final a()Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser$ImageType;
    ...
    .line 116
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lbgy;

    invoke-interface {v0}, Lbgy;->a()I
    ...
    invoke-interface {v0, v2, v3}, Lbgy;->a(J)J

    .line 129
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lbgy;

    invoke-interface {v0}, Lbgy;->c()I
    ...
    invoke-interface {v0, v6, v7}, Lbgy;->a(J)J
...
.method public final b()I
    ...
    .line 193
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Lbaw;

    const-class v3, [B

    invoke-interface {v0, v2, v3}, Lbaw;->a(ILjava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {v3, v0, v2}, Lbgy;->a([BI)I
    ...
    :cond_4
    :goto_2
    iget-object v2, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Lbaw;

    const-class v3, [B

    invoke-interface {v2, v0, v3}, Lbaw;->a(Ljava/lang/Object;Ljava/lang/Class;)V
    ...
    invoke-direct {v1, v0, v2}, Lbgx;-><init>([BI)V

    invoke-static {v1}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->a(Lbgx;)I
    :try_end_1

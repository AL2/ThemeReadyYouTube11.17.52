...
# virtual methods
.method public final a(Lflf;Lflo;Lflu;Lflx;Lflc;Lfkz;Lfma;Lfli;Lfll;Lflr;Lfmd;Z)Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/IApiPlayerService;
    .locals 5
    ...
    invoke-interface {p1}, Lflf;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p2}, Lflo;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p3}, Lflu;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p4}, Lflx;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p5}, Lflc;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p6}, Lfkz;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p7}, Lfma;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p8}, Lfli;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p9}, Lfll;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p10}, Lflr;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface/range {p11 .. p11}, Lfmd;->asBinder()Landroid/os/IBinder;
